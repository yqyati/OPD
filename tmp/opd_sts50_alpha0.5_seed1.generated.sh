...
export TRAIN_DATASET=datasets/opd_prompt_filter/opd_prompt_score_sts50_alpha0.5_seed1.parquet
...
export TRAIN_DATASET_NAME=DAPO-Math-17k-TeacherAligned-STS50-alpha0.5-seed1
...
MODEL_DIR="/mnt/shared-storage-gpfs2/p1-shared-2/yangqingyu/OPD/merged_models/opd_sts50_alpha0.5_seed1_lr${LR}_step${STEP}"
