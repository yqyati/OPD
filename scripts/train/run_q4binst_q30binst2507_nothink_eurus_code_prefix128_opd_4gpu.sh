#!/usr/bin/env bash
# Completion-aware fixed-prefix-128 code OPD:
...
export PREFIX_TRAIN_DATASET="${PREFIX_TRAIN_DATASET:-datasets/teacher_prefix/q4binst_q30binst2507_nothink_eurus_code_prefix128.parquet}"
export PREFIX_TRAIN_DATASET_NAME="Eurus-RL-Code-4BInst-30BInst-NoThink-Prefix128-CompletionAware"
export TEACHER_PREFIX_SFT_LOSS_COEF="${TEACHER_PREFIX_SFT_LOSS_COEF:-0.1}"
SFT_COEF_TAG="${TEACHER_PREFIX_SFT_LOSS_COEF/./p}"
export PREFIX_MODEL_OUTPUT_NAME_PREFIX="${PREFIX_MODEL_OUTPUT_NAME_PREFIX:-q4binst_q30binst2507_nothink_eurus_code_prefix128_sft${SFT_COEF_TAG}_opd_r4096_b96_n1_lr1e-5}"
...
# fixed 128-token teacher prefix at the handoff boundary.
export MAX_PROMPT_LENGTH=2176
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-q4binst_q30binst2507_nothink_eurus_code_prefix128_sft${SFT_COEF_TAG}_opd_r4096_b96_n1_lr1e-5_${RUN_TAG}}"
