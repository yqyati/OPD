#!/usr/bin/env bash
# Completion-aware fixed-prefix-256 OPD: Qwen3-1.7B-Base <- Qwen3-4B-Instruct-2507.
...
export PREFIX_TRAIN_DATASET="datasets/teacher_prefix/q3b_q4b_instruct2507_nothink_dapo_math17k_prefix256_from_fullresponse.parquet"
export PREFIX_TRAIN_DATASET_NAME="q3b_q4b_i2507_prefix256_completionaware"
export PREFIX_MODEL_OUTPUT_NAME_PREFIX="q3b_q4b_i2507_problem_solution_prefix256_sft${SFT_COEF_TAG}_opd_r4096_b64_n1_lr1e-5"
...
export EVAL_OUTPUT_DIR="${OPD_ROOT}/outputs/eval/problem_solution_prefix256_eos151643"

RUN_TAG="${RUN_TAG:-$(date +%Y-%m-%d_%H-%M-%S)}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-q3b_q4b_i2507_ps_prefix256_sft${SFT_COEF_TAG}_opd_r4096_b64_n1_lr1e-5_${RUN_TAG}}"
