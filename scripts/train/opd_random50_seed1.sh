...
export TRAIN_DATASET=datasets/opd_prompt_filter/opd_prompt_score_random50_seed1.parquet
...
export TRAIN_DATASET_NAME=DAPO-Math-17k-TeacherAligned-Random50-seed1
...
export ACTOR_MODEL_PATH=${MODEL_ROOT}/DeepSeek-R1-Distill-Qwen-1.5B
...
export REWARD_MODEL_PATH=${MODEL_ROOT}/JustRL-DeepSeek-1.5B
...
MODEL_DIR="${OPD_ROOT}/merged_models/opd_random50_seed1_lr${LR}_step${STEP}"
DATA_DIR="${OPD_ROOT}/scripts/val/data"
OUTPUT_DIR="${OPD_ROOT}/outputs/eval/justrl_eval_outputs_31744"
