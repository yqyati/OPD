...
if [ "$RUN_MODE" = "plain" ]; then
    ...
    export TRAIN_DATASET_NAME=${TRAIN_DATASET_NAME:-JustRL-PrefixSFTInit-PlainOPD-n1}
    export MODEL_OUTPUT_NAME_PREFIX=${MODEL_OUTPUT_NAME_PREFIX:-opd_justrl_prefix_sft_init_plain_opd_n${N_RESPONSES}_lr${LR}}
...
# export ACTOR_MODEL_PATH=model/DS-1.5B-SFT
export ACTOR_MODEL_NAME=${ACTOR_MODEL_NAME:-justrl_prefix_sft_init}
