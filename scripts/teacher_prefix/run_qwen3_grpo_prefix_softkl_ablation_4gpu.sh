...
SOFTKL_PREFIX_DATA=${SOFTKL_PREFIX_DATA:-datasets/teacher_prefix/qwen3_grpo_dapo_math_17k_teacher_prefix128_topk${LOG_PROB_TOP_K}.parquet}
...
TRAIN_DATASET_NAME="Qwen3GRPO-TP128-SFT0.1-SoftKL0.01-SuffixOPD" \
MODEL_OUTPUT_NAME_PREFIX="qwen3_grpo_tp128_sft0.1_softkl0.01_suffixopd_lr${LR}" \
